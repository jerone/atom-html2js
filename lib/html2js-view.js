...
export default class Html2JsView {
  ...
  show () {
    ...
    this.input.getModel().setText('<button class="btn btn-default tool-bar-btn fa fa-cloud-download" is="space-pen-button" title="" data-original-title="Restore (Sync Settings)" data-group="flex-toolBar" data-priority="45"></button>') // Debug
  }
